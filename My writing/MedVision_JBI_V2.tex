...
layer-by-layer computational graph. The permutation icon reproduces the v9
workflow but is not part of the current V2 inference; DeLong and McNemar use
retained seed-42 outputs, and each control has one retained run. (d) Retained
