...
\begin{figure}[pos=htbp]
\centering
\includegraphics[width=0.46\linewidth]{figures/reliability_diagram.png}
...
\begin{figure}[pos=htbp]
\centering
\includegraphics[width=0.62\linewidth]{figures/ece_seed_dots.png}
...
\begin{figure}[pos=htbp]
\centering
\includegraphics[width=0.60\linewidth]{figures/circularity_contrast.png}
...
\begin{figure}[pos=htbp]
\centering
\includegraphics[width=0.64\linewidth]{figures/paired_vlm_gray_square.png}
...
\begin{figure}[pos=htbp]
\centering
\includegraphics[width=0.64\linewidth]{figures/icm_tost_master.png}
...
\begin{figure}[pos=htbp]
\centering
\includegraphics[width=0.64\linewidth]{figures/gate_stagnation_with_dots.png}
