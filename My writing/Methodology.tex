...
\subsection{Study design, data source, and cohort construction}\label{sec:study-design}
...
\caption{Methodological framework linking data provenance, multimodal model
inputs, controlled ablations, and seed-level evaluation. The present study
instantiates this framework with MIMIC-CXR, patient-level splitting,
report-preserving image ablation, and matched seed-level inference.}
...
\subsection{Model architecture, variants, and controls}\label{sec:architecture}
...
\subsection{Training, endpoints, and statistical analysis}\label{sec:training}
...
\textbf{Endpoints and statistical analysis.}
