...
% Compact float spacing keeps the single-column review layout readable without
% allowing figures and captions to create avoidable blank pages.
...
\input{Reporting_Statements.tex}

\bibliographystyle{cas-model2-names}
% Keep the full reference list while allowing it to occupy a compact final page.
